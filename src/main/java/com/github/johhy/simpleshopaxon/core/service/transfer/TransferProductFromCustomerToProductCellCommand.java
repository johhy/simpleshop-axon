 ...
 *
 */
public class TransferProductFromCustomerToProductCellCommand {
	...
	public TransferProductFromCustomerToProductCellCommand(
	...
	public String toString() {
		return "TransferProductFromCustomerToProductCellCommand [codeOfProduct="
				+ codeOfProduct
				+ ", amount="
				+ amount
				+ ", price="
