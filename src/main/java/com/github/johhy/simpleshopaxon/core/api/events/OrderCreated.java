...
public class OrderCreated {
	...
	/**
	 * Instantiates a new order created.
	 *
	 ...
	 */
	public OrderCreated(final String customerIdOwnOrder, 
		final String orderIdCreated, 
	...
	public final String toString() {
		return "OrderCreated [customerId=" + customerId 
			+ ", orderId=" + orderId 
			+ ", created=" + created 
			+ ", shipTo=" + shipTo 
			+ ", products=" + products 
